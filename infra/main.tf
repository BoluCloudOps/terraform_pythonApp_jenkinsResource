...
module "security_group" {
  ...
  ec2_sg_name                = "SG for EC2 to enable SSH(22),HTTP(80),HTTPS(443),& PORT8200"
  ...
  ec2_jenkins_sg_name = "SG for EC2 to allow port 8080 for jenkins"
}

# Handles Jenkins Server Creation
module "jenkins" {
  source                    = "./jenkins"
  ami_id                    = var.ec2_ami_id
  instance_type             = "t2.medium"
  tag_name                  = "${var.env_prefix}-server"
